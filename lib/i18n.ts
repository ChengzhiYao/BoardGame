...
const ZH: Dict = {
  ...
  home_title: '克苏鲁调查团',
  home_tagline: '两名调查员，一条邀请链接，一位永不迷路、真相绝不更改的 AI 守秘人。你们将拼凑彼此手中的线索，直面不可名状之物。',
  home_name_ph: '你的调查员代号',
  mode_coc: '调查跑团（CoC）', mode_soup: '海龟汤', mode_td: '真心话大冒险', mode_jbs: '剧本杀',
  create_coc: '创建调查', create_soup: '创建海龟汤', create_td: '创建真心话大冒险', create_jbs: '创建剧本杀',
  starting: '正在开启…', join_btn: '输入邀请码加入', join_code_ph: '粘贴邀请码', join_do: '加入', joining: '正在加入…',
  err_name: '先填一个调查员代号', err_code: '粘贴邀请码',
...
const EN: Dict = {
  ...
  home_title: 'Call of the Deep',
  home_tagline: 'Two investigators, one invite link, and an AI Keeper who never loses the thread and never changes the truth. Piece together the clues in each other’s hands and face the unnameable.',
  home_name_ph: 'Your investigator name',
  mode_coc: 'Investigation (CoC)', mode_soup: 'Lateral Mystery', mode_td: 'Truth or Dare', mode_jbs: 'Murder Mystery',
  create_coc: 'Create Investigation', create_soup: 'Create Mystery', create_td: 'Create Truth or Dare', create_jbs: 'Create Murder Mystery',
  starting: 'Opening…', join_btn: 'Join with invite code', join_code_ph: 'Paste invite code', join_do: 'Join', joining: 'Joining…',
  err_name: 'Enter an investigator name first', err_code: 'Paste the invite code',
