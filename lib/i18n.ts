...
const ZH: Dict = {
  ...
  mode_coc: '调查跑团（CoC）', mode_soup: '海龟汤', mode_td: '真心话大冒险',
  create_coc: '创建调查', create_soup: '创建海龟汤', create_td: '创建真心话大冒险',
...
const EN: Dict = {
  ...
  mode_coc: 'Investigation (CoC)', mode_soup: 'Lateral Mystery', mode_td: 'Truth or Dare',
  create_coc: 'Create Investigation', create_soup: 'Create Mystery', create_td: 'Create Truth or Dare',
