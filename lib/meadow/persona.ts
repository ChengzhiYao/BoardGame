...
export const QUESTIONS: Q[] = [
  ...
  { zh: '天黑了，大多动物回巢，你？', opts: [
    ...
    { zh: '和同伴挤一起取暖', p: { social: 2, altru: 1 }, sp: { rabbit: 1, deer: 1, sheep: 1 } },
  ] },
  { zh: '发现一处又安全又隐蔽的好地方，你会？', opts: [
    { zh: '占为己有，谁都不准来', p: { altru: -1, social: -1, wild: 1 }, sp: { fox: 1, weasel: 1, lion: 2, tiger: 1 } },
  ...
  { zh: '你饿极了，眼前只有一只受伤的小动物，你？', opts: [
    ...
    { zh: '下不去口，去别处找草籽', p: { fierce: -2, altru: 1 }, i: { forage: 1 }, grass: 2, sp: { rabbit: 1, deer: 1, sheep: 1 } },
  ...
  { zh: '一条没走过的小路通向草原边缘，你？', opts: [
    { zh: '好奇心爆棚，一定要去探', p: { curious: 2, brave: 1 }, sp: { squirrel: 1, crow: 1, hawk: 1 } },
    { zh: '太危险，绝不冒险', p: { curious: -2, wild: -1 }, sp: { rabbit: 1, mouse: 1 } },
    { zh: '远远观察一阵再说', a: { sen: 1 }, p: { calm: 1 }, i: { stealth: 1 }, sp: { deer: 1, hedgehog: 1, snake: 1 } },
    { zh: '独自前往，不告诉任何人', p: { social: -2, wild: 1 }, sp: { fox: 1, tiger: 2 } },
  ] },
  { zh: '巢里最暖和的位置，你？', opts: [
    { zh: '当仁不让，强者先得', a: { str: 1 }, p: { fierce: 1, altru: -1 }, sp: { badger: 1, weasel: 1, boar: 1, lion: 2 } },
  ...
  { zh: '暴雨突至，你？', opts: [
    { zh: '顶着雨继续做该做的事', a: { vit: 2 }, p: { calm: 1 }, sp: { badger: 1, boar: 1 } },
  ...
  { zh: '你看待"规矩"（兽群传统、长辈的话）？', opts: [
    ...
    { zh: '规矩让大家活下来，该守', p: { wild: -2, social: 1 }, sp: { rabbit: 1, deer: 1, sheep: 2 } },
  ...
  { zh: '一群同类要推举带头的，大家看你，你？', opts: [
    { zh: '我来带！跟我走', a: { cha: 2 }, p: { brave: 1, social: 1 }, i: { social: 1 }, sp: { deer: 1, rabbit: 1, lion: 2 } },
    { zh: '推举更合适的，我帮衬', p: { wild: -1, altru: 1 }, i: { social: 1 }, sp: { rabbit: 1 } },
    { zh: '没兴趣，走自己的路', p: { social: -2 }, sp: { fox: 1, hedgehog: 1, tiger: 2 } },
    { zh: '暗中观察谁最有用', a: { wit: 2 }, p: { altru: -1 }, i: { stealth: 1 }, sp: { crow: 1, fox: 1, snake: 2 } },
  ] },
  ...
  { zh: '有机会去一个陌生远方，你？', opts: [
    { zh: '出发！未知最迷人', p: { curious: 2, brave: 1, wild: 1 }, sp: { crow: 1, fox: 1, hawk: 1 } },
    { zh: '留在熟悉草原最安心', p: { curious: -1, wild: -1, social: 1 }, sp: { rabbit: 1, mouse: 1 } },
    { zh: '先打听清楚再决定', a: { wit: 1 }, p: { calm: 1 }, i: { social: 1 }, sp: { crow: 1 } },
    { zh: '独自悄悄去，不惊动谁', p: { social: -2 }, i: { stealth: 1 }, sp: { fox: 1, hedgehog: 1, tiger: 1 } },
  ] },
  { zh: '同伴背叛、出卖了你，你？', opts: [
    ...
    { zh: '设个法子让它自食其果', a: { wit: 2 }, p: { altru: -1, wild: 1 }, sp: { fox: 1, crow: 1, snake: 2 } },
  ] },
  { zh: '你梦里最常出现的画面？', opts: [
    ...
    { zh: '一大家子热热闹闹', p: { social: 2, altru: 1 }, sp: { rabbit: 1, deer: 1, sheep: 1 } },
    { zh: '飞起来俯瞰整片草原', a: { wit: 1 }, p: { curious: 1 }, sp: { crow: 1, owl: 1, hawk: 2 }, trait: '翅膀' },
  ] },
  { zh: '又高又险但有宝贝的地方，你？', opts: [
    { zh: '凭力气硬闯上去', a: { str: 2, vit: 1 }, p: { brave: 1 }, sp: { badger: 1, boar: 2 } },
  ...
  { zh: '如果你早晚会被吃掉或老死，你想怎样活这一生？', opts: [
    { zh: '做最强的猎手，让谁都怕我', a: { str: 1 }, p: { fierce: 2, brave: 1 }, i: { hunt: 1 }, meat: 2, sp: { fox: 1, weasel: 1, owl: 1, wolf: 2, lion: 2, tiger: 2 } },
