...
export const QUESTIONS: Q[] = [
  { zh: '草丛深处传来你听不懂的窸窣声，你？', opts: [
    ...
    { zh: '僵住、竖耳分辨方向', a: { sen: 2 }, p: { curious: -1 }, i: { flee: 1 }, grass: 1, sp: { rabbit: 1, fawn: 1 } },
  ...
  { zh: '一小堆没人要的果子/种子，你会？', opts: [
    ...
    { zh: '喊同伴一起来分', a: { cha: 1 }, p: { social: 2, altru: 2 }, i: { social: 1 }, sp: { rabbit: 1, fawn: 1 } },
    { zh: '只拿够吃的，剩下留给别人', p: { fierce: -1, wild: -1, altru: 1 }, sp: { fawn: 1 } },
  ] },
  { zh: '一只比你弱小的动物挡了路，你？', opts: [
    { zh: '凶它、赶走甚至扑上去', a: { str: 1 }, p: { fierce: 2 }, i: { hunt: 1 }, meat: 2, sp: { fox: 1, weasel: 1, owl: 1 } },
    { zh: '客气地请它让让', a: { cha: 1 }, p: { fierce: -2, wild: -1 }, i: { social: 1 }, grass: 1, sp: { rabbit: 1, fawn: 1 } },
  ...
  { zh: '天黑了，大多动物回巢，你？', opts: [
    ...
    { zh: '留在外面看星星发呆', p: { curious: 1, calm: 1, social: -1 }, sp: { fawn: 1 } },
    { zh: '和同伴挤一起取暖', p: { social: 2, altru: 1 }, sp: { rabbit: 1, fawn: 1 } },
  ] },
  ...
  { zh: '远处传来同伴的尖叫——危险！你？', opts: [
    { zh: '冲过去看能不能帮忙', p: { brave: 2, altru: 2 }, sp: { badger: 1, fawn: 1 } },
    { zh: '第一时间撒腿就跑', a: { agi: 2 }, p: { brave: -1 }, i: { flee: 2 }, sp: { rabbit: 1, fawn: 1 }, trait: '飞毛腿' },
  ...
  { zh: '你饿极了，眼前只有一只受伤的小动物，你？', opts: [
    ...
    { zh: '下不去口，去别处找草籽', p: { fierce: -2, altru: 1 }, i: { forage: 1 }, grass: 2, sp: { rabbit: 1, fawn: 1 } },
    { zh: '看情况，先饱肚子要紧', p: { calm: 1, altru: -1 }, sp: { badger: 1, crow: 1 } },
    { zh: '帮它包扎，也许能交个朋友', a: { cha: 1 }, p: { altru: 2 }, i: { social: 1 }, sp: { fawn: 1 } },
  ] },
  ...
  { zh: '一条没走过的小路通向草原边缘，你？', opts: [
    ...
    { zh: '远远观察一阵再说', a: { sen: 1 }, p: { calm: 1 }, i: { stealth: 1 }, sp: { fawn: 1, hedgehog: 1 } },
    { zh: '独自前往，不告诉任何人', p: { social: -2, wild: 1 }, sp: { fox: 1 } },
  ] },
  { zh: '巢里最暖和的位置，你？', opts: [
    { zh: '当仁不让，强者先得', a: { str: 1 }, p: { fierce: 1, altru: -1 }, sp: { badger: 1, weasel: 1 } },
    { zh: '让给老弱', p: { altru: 2, fierce: -1, wild: -1 }, sp: { fawn: 1, rabbit: 1 } },
  ...
  { zh: '你看待"规矩"（兽群传统、长辈的话）？', opts: [
    ...
    { zh: '规矩让大家活下来，该守', p: { wild: -2, social: 1 }, sp: { rabbit: 1, fawn: 1 } },
  ...
  { zh: '一群同类要推举带头的，大家看你，你？', opts: [
    { zh: '我来带！跟我走', a: { cha: 2 }, p: { brave: 1, social: 1 }, i: { social: 1 }, sp: { fawn: 1, rabbit: 1 } },
  ...
  { zh: '危险逼近的一瞬，你的身体先做什么？', opts: [
    ...
    { zh: '瞬间弹射逃开', a: { agi: 2 }, i: { flee: 2 }, sp: { rabbit: 1, fawn: 1 }, trait: '飞毛腿' },
  ...
  { zh: '同伴背叛、出卖了你，你？', opts: [
    ...
    { zh: '想弄明白它为何这么做', a: { wit: 1 }, p: { fierce: -1, calm: 1 }, sp: { fawn: 1 } },
    { zh: '设个法子让它自食其果', a: { wit: 2 }, p: { altru: -1, wild: 1 }, sp: { fox: 1, crow: 1 } },
  ] },
  { zh: '你梦里最常出现的画面？', opts: [
    { zh: '一场酣畅淋漓的追猎', a: { str: 1 }, p: { fierce: 1 }, i: { hunt: 2 }, meat: 1, sp: { fox: 1, owl: 1 } },
    { zh: '吃不完的青草和阳光', p: { fierce: -1, calm: 1 }, i: { forage: 1 }, grass: 1, sp: { rabbit: 1, fawn: 1 } },
    { zh: '一大家子热热闹闹', p: { social: 2, altru: 1 }, sp: { rabbit: 1, fawn: 1 } },
  ...
  { zh: '如果你早晚会被吃掉或老死，你想怎样活这一生？', opts: [
    ...
    { zh: '平平安安，看儿孙满草原', p: { fierce: -1, altru: 1, social: 1 }, i: { build: 1 }, grass: 1, sp: { rabbit: 1, fawn: 1 }, trait: '多子' },
    { zh: '走遍每个角落，看尽奇景', p: { curious: 2, wild: 1 }, sp: { crow: 1, squirrel: 1 } },
    { zh: '守护好我在乎的人', p: { altru: 2, brave: 1, wild: -1 }, sp: { badger: 1, fawn: 1 } },
  ] },
];
...
export function scoreTest(answers: (number | null)[], rng: () => number = Math.random): MeadowResult {
  ...
  return { attributes: attrs, instincts: insts, personality: p, diet: pick.diet, speciesKey: pick.key, traits };
}
