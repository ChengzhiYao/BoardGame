...
const ZH: Dict = {
  ...
  home_name_ph: '你的昵称',
  mode_coc: '调查跑团（CoC）', mode_soup: '海龟汤', mode_td: '真心话大冒险', mode_jbs: '剧本杀', mode_botc: '血染（社交推理）', mode_mcc: '午夜猫诅咒（牌局）', mode_dnd: '龙与地下城（D&D）', mode_story: '讲故事',
  create_coc: '创建调查', create_soup: '创建海龟汤', create_td: '创建真心话大冒险', create_jbs: '创建剧本杀', create_botc: '创建血染', create_mcc: '创建午夜猫诅咒', create_dnd: '创建龙与地下城', create_story: '创建故事',
...
const EN: Dict = {
  ...
  mode_coc: 'Investigation (CoC)', mode_soup: 'Lateral Mystery', mode_td: 'Truth or Dare', mode_jbs: 'Murder Mystery', mode_botc: 'Bloodbound (social deduction)', mode_mcc: 'Midnight Cat Curse (cards)', mode_dnd: 'Dungeons & Dragons (D&D)', mode_story: 'Storyteller',
  create_coc: 'Create Investigation', create_soup: 'Create Mystery', create_td: 'Create Truth or Dare', create_jbs: 'Create Murder Mystery', create_botc: 'Create Bloodbound', create_mcc: 'Create Midnight Cat Curse', create_dnd: 'Create D&D Quest', create_story: 'Create a Story',
