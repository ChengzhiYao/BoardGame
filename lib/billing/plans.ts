...
export const PACKS: Pack[] = [
  { id: 'p2',  games: 2,  price: 990,  label: '入门 · 2 局',  perGame: '约 4.95 元/局' },
  { id: 'p5',  games: 5,  price: 1990, label: '标准 · 5 局',  perGame: '约 3.98 元/局', tag: '最受欢迎' },
  { id: 'p15', games: 15, price: 3800, label: '超值 · 15 局', perGame: '约 2.53 元/局', tag: '最划算' },
];
